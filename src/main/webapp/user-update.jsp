                        ...
                        <form action="/user/update" class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="password" name="password" value="${pageContext.session.getAttribute('find_user').password}" class="form-control" id="inputPassword3"
                                               placeholder="密码">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <!-- /.box-body -->
                            <%--            隐藏域--%>
                            <input type="hidden" name="id" value="${find_user.id}">
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="location.href='/user/findAll'">取消</button>
